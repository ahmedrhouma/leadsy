        ...
        <div class="card-body pt-0">
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5 h-100" id="kt_campaigns_table">
                ...
                <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                    ...
                    <th>@lang('admin/campaigns.advertiser_name')</th>
                    <th>@lang('admin/campaigns.id')</th>
                    <th>@lang('admin/campaigns.name')</th>
                    <th>@lang('admin/campaigns.creation_date')</th>
                    <th>@lang('admin/campaigns.starting_date')</th>
                    <th>@lang('admin/campaigns.ending_date')</th>
                    <th>@lang('admin/campaigns.status')</th>
                    <th>@choice('admin/campaigns.thematic',1)</th>
                    <th class="min-w-100px">@choice('admin/campaigns.country_scope',1)</th>
                    <th class="min-w-100px">@choice('admin/campaigns.lead_type',1)</th>
                    <th>@lang('admin/campaigns.expected_leads_volume')</th>
                    <th class="min-w-100px">@choice('admin/campaigns.cost_type',1)</th>
                    <th>@lang('admin/campaigns.max_fixed_amount')</th>
