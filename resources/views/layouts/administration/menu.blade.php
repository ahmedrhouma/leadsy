        ...
        <div id="kt_aside_menu_wrapper" class="w-100 hover-scroll-overlay-y scroll-ps d-flex" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside, #kt_aside_menu" data-kt-scroll-offset="0">
            <div id="kt_aside_menu" class="menu menu-column menu-title-gray-600 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-icon-gray-400 menu-arrow-gray-400 fw-bold fs-6" data-kt-menu="true">
                <div class="menu-item py-3">
                    <a class="menu-link @if (\Route::is('admin.dashboard')) active @endif" href="{{route('admin.dashboard')}}" title="Dashboard" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                ...
                <div class="menu-item py-3">
                    <a class="menu-link @if (\Route::is('admin.thematics')) active @endif" href="{{route('admin.thematics')}}" title="Thematic" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                        <span class="menu-icon">
                ...
                <div class="menu-item py-3">
                    <a class="menu-link @if (\Route::is('admin.publishers')) active @endif" href="{{route('admin.publishers')}}" title="Publishers" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: assets/media/icons/duotune/art/art008.svg-->
                ...
                <div class="menu-item py-3">
                    <a class="menu-link @if (\Route::is('admin.advertisers')) active @endif" href="{{route('admin.advertisers')}}" title="Advertisers" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: assets/media/icons/duotune/general/gen002.svg-->
                            <span class="svg-icon svg-icon-muted svg-icon-2hx"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <div class="menu-item py-3">
                    <a class="menu-link @if (\Route::is('admin.campaigns')) active @endif" href="{{route('admin.campaigns')}}" title="Campaigns" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                        <span class="menu-icon">
                ...
                <div class="menu-item py-3">
                    <a class="menu-link @if (\Route::is('admin.leads')) active @endif" href="{{route('admin.leads')}}" title="Leads" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                        <span class="menu-icon">
                ...
                <div class="menu-item py-3">
                    <a class="menu-link @if (\Route::is('admin.reports')) active @endif" href="reports" title="Campaign reports" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
                        <span class="menu-icon">
