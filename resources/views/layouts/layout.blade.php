...
<div class="d-flex flex-column flex-root">
    ...
    <div class="page d-flex flex-row flex-column-fluid">
        <!--begin::Aside-->
        @admin
        @include('layouts.administration.menu')
        @endadmin
        @advertiser
        @include('layouts.advertiser.menu')
        @endadvertiser
        @publisher
            ...
            <div id="kt_header" class="header py-6 py-lg-0" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{lg: '300px'}">
                ...
                <div class="header-container container-fluid">
                    ...
                    <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-20 py-3 py-lg-0 me-3">
                        <!--begin::Heading-->
                        @admin
                        @include('layouts.administration.heading')
                        @endadmin
                        @advertiser
                        @include('layouts.advertiser.heading')
                        @endadvertiser
                        @publisher
                        @include('layouts.publisher.heading')
                        @endpublisher
                        <!--end::Heading-->
                    </div>
                    <!--end::Page title=-->
                                ...
                                <div data-kt-search-element="content" class="menu menu-sub menu-sub-dropdown w-300px w-md-350px py-7 px-7 overflow-hidden">
                                    ...
                                    <form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
                                        ...
                                        <div class="d-flex justify-content-end">
                                            <button type="reset" class="btn btn-sm btn-light fw-bolder btn-active-light-primary me-2" data-kt-search-element="advanced-options-form-cancel">
                                                Cancel
                                            </button>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade" id="kt_topbar_notifications_1" role="tabpanel">
                                            ...
                                            <div class="py-3 text-center border-top">
                                                <a href="profile_activity" class="btn btn-color-gray-600 btn-active-color-primary">View
                                                    All
