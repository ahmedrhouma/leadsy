    ...
    <div class="card mb-5 mb-xxl-8">
        <div class="card-body pt-9 pb-0">
                    ...
                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1">{{auth()->user()->account->name}}</a>
                                <a href="#">
                        ...
                        <div class="d-flex my-4">
                            <a href="#" class="btn btn-sm btn-light me-2">
                                ...
                                <span class="indicator-label">Billing</span>
                                <span class="indicator-progress">Please wait...
														<span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                            </a>
                            <a href="#" class="btn btn-sm btn-primary me-2" data-bs-toggle="modal" data-bs-target="#kt_modal_offer_a_deal">Invoices</a>
                        </div>
                            ...
                            <div class="d-flex flex-wrap">
                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="fs-2 fw-bolder" data-kt-countup="true" data-kt-countup-value="4500" data-kt-countup-prefix="$">
                                            0
                                        </div>
                                    </div>
                                    <div class="fw-bold fs-6 text-gray-400">Leads</div>
                                </div>
                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="fs-2 fw-bolder" data-kt-countup="true" data-kt-countup-value="80">
                                            0
                                        </div>
                                    </div>
                                    <div class="fw-bold fs-6 text-gray-400">Campaigns</div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
                ...
                <li class="nav-item mt-2">
                    <a class="nav-link text-active-primary ms-0 me-10 py-5" href="profile_activity">Activity</a>
                </li>
            </ul>
        </div>
    </div>
            ...
            <form id="kt_account_profile_details_form" class="form" enctype="multipart/form-data">
                ...
                <div class="card-body border-top p-9">
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            <div class="fv-row">
                                <input type="text" name="name" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Full name" value="{{ auth()->user()->account->name }}"/>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-6">
                    ...
                    <div id="kt_signin_email_edit" class="flex-row-fluid d-none">
                        ...
                        <form id="kt_signin_change_email" class="form" novalidate="novalidate">
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-6">
                                    <div class="fv-row mb-0">
                                        <label for="confirmemailpassword" class="form-label fs-6 fw-bolder mb-3">Your
                                            paswword</label>
                                        <input type="password" class="form-control form-control-lg form-control-solid" name="confirmemailpassword" id="confirmemailpassword" autocomplete="off"/>
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex">
            ...
            $.ajax(
                {
                    ...
                    success: function (data) {
                        if (data == "") {
                            ...
                            $('#kt_signin_change_password').reset();
                        }
                    },
                    error: function (error) {
                        Swal.fire({
                            text: error.responseJSON.errors.join('<br>'),
                            icon: "error",
                            customClass: {
            ...
            $.ajax(
                {
                    ...
                    data: {
                        ...
                        current_password: $('#confirmemailpassword').val(),
                        _token: '{{ csrf_token() }}',
                        _method: 'PUT'
                    },
                    success: function (data) {
